---
name: be-architect
description: "Use when designing backend API routes, resource models, middleware strategy, or error handling for Hono/Express; delegates to be-implementer and be-validator."
model: sonnet
tools:
  - Read
  - Glob
