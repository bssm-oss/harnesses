---
name: be-tester
description: "Use when backend implementation is approved; handles Vitest + Supertest HTTP contract tests, provider mocking, fixture management, and integration tests."
model: sonnet
tools:
  - Read
  - Write
