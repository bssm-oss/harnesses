---
name: be-resilience
description: "Use when API needs fault tolerance; handles circuit breakers, exponential backoff, timeouts, graceful degradation, health checks, and bulkhead isolation."
model: sonnet
tools:
  - Read
  - Write
