---
name: dev-planner
description: "Use when starting a new feature or task; handles requirement breakdown, acceptance criteria in Given/When/Then format, and handoff spec to dev-frontend and dev-backend."
model: sonnet
tools:
  - Read
  - Write
